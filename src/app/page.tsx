...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col gap-12">
      <section className="rounded-xl border border-black/10 bg-orange-500/5 p-8 dark:border-white/10">
        <h1 className="text-3xl font-bold sm:text-4xl">
          Bienvenue sur Youzon Ligue Pro
        </h1>
      ...
      <div className="grid gap-10 lg:grid-cols-3">
        ...
        <section>
          ...
          <ol className="flex flex-col gap-2">
            ...
            {standings.length === 0 && (
              <p className="text-black/60 dark:text-white/60">Pas encore de classement.</p>
            )}
          </ol>
          <Link href="/classement" className="mt-4 inline-block text-sm text-orange-500 underline">
